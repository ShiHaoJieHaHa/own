	...
	setColumns : function(p) {
		...
		return this.each(function(){
			...
			if ( $("#"+IDs.themodal).html() != null ) {
				...
				var bS  = !p.updateAfterCheck ? "<a href='javascript:void(0)' id='dData' class='fm-menu ui-state-default ui-corner-all'>"+p.bSubmit+"</a>" : "",
				bC  ="<a href='javascript:void(0)' id='eData' class='fm-menu ui-state-default ui-corner-all'>"+p.bCancel+"</a>";
				...
				if(p.saveicon[0]==true) {
					$("#dData","#"+dtbl+"_2").addClass(p.saveicon[1] == "right" ? 'fm-menu-icon-right' : 'fm-menu-icon-left')
					.append("<span class='ui-icon "+p.saveicon[2]+"'></span>");
				}
				if(p.closeicon[0]==true) {
					$("#eData","#"+dtbl+"_2").addClass(p.closeicon[1] == "right" ? 'fm-menu-icon-right' : 'fm-menu-icon-left')
