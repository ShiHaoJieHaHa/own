...
c,d,f,g,h,j,k,o="<td class='ui-pg-menu "+n+"'><span class='ui-separator'></span></td>",q="",s="<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>",t="",u=function(a,b){var
...
w=["first"+b,"prev"+b,"next"+b,"last"+b],x=l(m,"pgButtonBox",!0,"ui-pg-menu"),y=[$.jgrid.getRegional(e,"defaults.pgfirst",e.p.pgfirst)||"",$.jgrid.getRegional(e,"defaults.pgprev",e.p.pgprev)||"",$.jgrid.getRegional(e,"defaults.pgnext",e.p.pgnext)||"",$.jgrid.getRegional(e,"defaults.pglast",e.p.pglast)||""];"rtl"===i&&(w.reverse(),y.reverse()),s+="<td id='"+w[0]+"' class='"+x+"' title='"+y[0]+"'><span "+l(m,"icon_first",!1,r)+"></span></td>",s+="<td id='"+w[1]+"' class='"+x+"'  title='"+y[1]+"'><span "+l(m,"icon_prev",!1,r)+"></span></td>",s+=""!==q?o+q+o:"",s+="<td id='"+w[2]+"' class='"+x+"' title='"+y[2]+"'><span "+l(m,"icon_next",!1,r)+"></span></td>",s+="<td id='"+w[3]+"' class='"+x+"' title='"+y[3]+"'><span "+l(m,"icon_end",!1,r)+"></span></td>"}else""!==q&&(s+=q);"ltr"===i&&(s+=t),s+="</tr></tbody></table>",!0===e.p.viewrecords&&$("td#"+a+"_"+e.p.recordpos,"#"+c).append("<div dir='"+i+"' style='text-align:"+e.p.recordpos+"' class='ui-paging-info'></div>"),$("td#"+a+"_"+e.p.pagerpos,"#"+c).append(s),j=$("#gbox_"+$.jgrid.jqID(e.p.id)).css("font-size")||"11px",$("#gbox_"+$.jgrid.jqID(e.p.id)).append("<div id='testpg' "+l(m,"entrieBox",!1,"ui-jqgrid")+" style='font-size:"+j+";visibility:hidden;' ></div>"),h=$(s).clone().appendTo("#testpg").width(),$("#testpg").remove(),h>0&&(""!==q&&(h+=50),$("td#"+a+"_"+e.p.pagerpos,"#"+c).width(h)),e.p._nvtd=[],e.p._nvtd[0]=h?Math.floor((e.p.width-h)/2):Math.floor(e.p.width/3),e.p._nvtd[1]=0,s=null,$(".ui-pg-selbox","#"+c).on("change",function(){return!!u("records",this)&&(e.p.page=Math.round(e.p.rowNum*(e.p.page-1)/this.value-.5)+1,e.p.rowNum=this.value,e.p.pager&&$(".ui-pg-selbox",e.p.pager).val(this.value),e.p.toppager&&$(".ui-pg-selbox",e.p.toppager).val(this.value),V(),!1)}),!0===e.p.pgbuttons&&($(".ui-pg-menu","#"+c).hover(function(){$(this).hasClass(n)?this.style.cursor="default":($(this).addClass(p),this.style.cursor="pointer")},function(){$(this).hasClass(n)||($(this).removeClass(p),this.style.cursor="default")}),$("#first"+$.jgrid.jqID(b)+", #prev"+$.jgrid.jqID(b)+", #next"+$.jgrid.jqID(b)+", #last"+$.jgrid.jqID(b)).click(function(){if($(this).hasClass(n))return!1;var
...
M="rtl"===s.p.direction,N=M?"nData":"pData",O=M?"pData":"nData",P="<a id='"+N+"' class='fm-menu "+h.button+"'><span class='"+h.icon_base+" "+g.icon_prev+"'></span></a>",Q="<a id='"+O+"' class='fm-menu "+h.button+"'><span class='"+h.icon_base+" "+g.icon_next+"'></span></a>",R="<a id='sData' class='fm-menu "+h.button+"'>"+d.bSubmit+"</a>",S="<a id='cData' class='fm-menu "+h.button+"'>"+d.bCancel+"</a>",T="<table style='height:auto' class='EditTable ui-common-table' id='"+z+"_2'><tbody><tr><td colspan='2'><hr class='"+h.content+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+(M?Q+P:P+Q)+"</td><td class='EditButton'>"+R+S+"</td></tr>";if(T+="</tbody></table>",E>0){var
...
z="rtl"===l.p.direction,A=z?"nData":"pData",B=z?"pData":"nData",C="<a id='"+A+"' class='fm-menu "+h.button+"'><span class='"+h.icon_base+" "+g.icon_prev+"'></span></a>",D="<a id='"+B+"' class='fm-menu "+h.button+"'><span class='"+h.icon_base+" "+g.icon_next+"'></span></a>",E="<a id='cData' class='fm-menu "+h.button+"'>"+d.bClose+"</a>";if(u>0){var
...
u="<a id='dData' class='fm-menu "+h.button+"'>"+d.bSubmit+"</a>",v="<a id='eData' class='fm-menu "+h.button+"'>"+d.bCancel+"</a>";if(t+="<table class='EditTable ui-common-table' id='"+o+"_2'><tbody><tr><td><hr class='"+h.content+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>"+u+"&#160;"+v+"</td></tr></tbody></table>",d.gbox="#gbox_"+a.jgrid.jqID(l),a.jgrid.createModal(q,t,b[e.p.id],"#gview_"+a.jgrid.jqID(e.p.id),a("#gview_"+a.jgrid.jqID(e.p.id))[0]),a(".fm-menu","#"+o+"_2").hover(function(){a(this).addClass(h.hover)},function(){a(this).removeClass(h.hover)}),d.delicon=a.extend([!0,"left",g.icon_del],b[e.p.id].delicon),d.cancelicon=a.extend([!0,"left",g.icon_cancel],b[e.p.id].cancelicon),!0===d.delicon[0]&&a("#dData","#"+o+"_2").addClass("right"===d.delicon[1]?"fm-menu-icon-right":"fm-menu-icon-left").append("<span class='"+h.icon_base+" "+d.delicon[2]+"'></span>"),!0===d.cancelicon[0]&&a("#eData","#"+o+"_2").addClass("right"===d.cancelicon[1]?"fm-menu-icon-right":"fm-menu-icon-left").append("<span class='"+h.icon_base+" "+d.cancelicon[2]+"'></span>"),a("#dData","#"+o+"_2").click(function(){var
...
u,v,w,x=a("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),y="<td class='ui-pg-menu "+l.disabled+"' style='width:4px;'><span class='ui-separator'></span></td>";0===q?(v=b,w=p.p.id,v===p.p.toppager&&(w+="_top",r=1)):(v=p.p.toppager,w=p.p.id+"_top"),"rtl"===p.p.direction&&a(x).attr("dir","rtl").css("float","right"),e=e||{},n.add&&(u=a("<td class='ui-pg-menu "+l.cornerall+"'></td>"),a(u).append("<div class='ui-pg-div'><span class='"+l.icon_base+" "+n.addicon+"'></span>"+n.addtext+"</div>"),a("tr",x).append(u),a(u,x).attr({title:n.addtitle||"",id:e.id||"add_"+w}).click(function(){return a(this).hasClass(l.disabled)||(a.isFunction(n.addfunc)?n.addfunc.call(p):a(p).jqGrid("editGridRow","new",e)),!1}).hover(s,t),u=null),d=d||{},n.edit&&(u=a("<td class='ui-pg-menu "+l.cornerall+"'></td>"),a(u).append("<div class='ui-pg-div'><span class='"+l.icon_base+" "+n.editicon+"'></span>"+n.edittext+"</div>"),a("tr",x).append(u),a(u,x).attr({title:n.edittitle||"",id:d.id||"edit_"+w}).click(function(){if(!a(this).hasClass(l.disabled)){var
b=p.p.selrow;b?a.isFunction(n.editfunc)?n.editfunc.call(p,b):a(p).jqGrid("editGridRow",b,d):(a.jgrid.viewModal("#"+o.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(s,t),u=null),h=h||{},n.view&&(u=a("<td class='ui-pg-menu "+l.cornerall+"'></td>"),a(u).append("<div class='ui-pg-div'><span class='"+l.icon_base+" "+n.viewicon+"'></span>"+n.viewtext+"</div>"),a("tr",x).append(u),a(u,x).attr({title:n.viewtitle||"",id:h.id||"view_"+w}).click(function(){if(!a(this).hasClass(l.disabled)){var
b=p.p.selrow;b?a.isFunction(n.viewfunc)?n.viewfunc.call(p,b):a(p).jqGrid("viewGridRow",b,h):(a.jgrid.viewModal("#"+o.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(s,t),u=null),f=f||{},n.del&&(u=a("<td class='ui-pg-menu "+l.cornerall+"'></td>"),a(u).append("<div class='ui-pg-div'><span class='"+l.icon_base+" "+n.delicon+"'></span>"+n.deltext+"</div>"),a("tr",x).append(u),a(u,x).attr({title:n.deltitle||"",id:f.id||"del_"+w}).click(function(){if(!a(this).hasClass(l.disabled)){var
b;p.p.multiselect?(b=p.p.selarrrow,0===b.length&&(b=null)):b=p.p.selrow,b?a.isFunction(n.delfunc)?n.delfunc.call(p,b):a(p).jqGrid("delGridRow",b,f):(a.jgrid.viewModal("#"+o.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(s,t),u=null),(n.add||n.edit||n.del||n.view)&&a("tr",x).append(y),g=g||{},n.search&&(u=a("<td class='ui-pg-menu "+l.cornerall+"'></td>"),a(u).append("<div class='ui-pg-div'><span class='"+l.icon_base+" "+n.searchicon+"'></span>"+n.searchtext+"</div>"),a("tr",x).append(u),a(u,x).attr({title:n.searchtitle||"",id:g.id||"search_"+w}).click(function(){return a(this).hasClass(l.disabled)||(a.isFunction(n.searchfunc)?n.searchfunc.call(p,g):a(p).jqGrid("searchGrid",g)),!1}).hover(s,t),g.showOnLoad&&!0===g.showOnLoad&&a(u,x).click(),u=null),n.refresh&&(u=a("<td class='ui-pg-menu "+l.cornerall+"'></td>"),a(u).append("<div class='ui-pg-div'><span class='"+l.icon_base+" "+n.refreshicon+"'></span>"+n.refreshtext+"</div>"),a("tr",x).append(u),a(u,x).attr({title:n.refreshtitle||"",id:"refresh_"+w}).click(function(){if(!a(this).hasClass(l.disabled)){a.isFunction(n.beforeRefresh)&&n.beforeRefresh.call(p),p.p.search=!1,p.p.resetsearch=!0;try{if("currentfilter"!==n.refreshstate){var
...
k=a("<td></td>");"NONE"===c.buttonicon.toString().toUpperCase()?a(k).addClass("ui-pg-menu "+i).append("<div class='ui-pg-div'>"+c.caption+"</div>"):a(k).addClass("ui-pg-menu "+i).append("<div class='ui-pg-div'><span class='"+j+" "+c.buttonicon+"'></span>"+c.caption+"</div>"),c.id&&a(k).attr("id",c.id),"first"===c.position?0===e.rows[0].cells.length?a("tr",e).append(k):a("tr td:eq(0)",e).before(k):a("tr",e).append(k),a(k,e).attr("title",c.title||"").click(function(b){return a(this).hasClass(g)||a.isFunction(c.onClickButton)&&c.onClickButton.call(f,b),!1}).hover(function(){a(this).hasClass(g)||a(this).addClass(h)},function(){a(this).removeClass(h)})}else
...
b&&0!==b.indexOf("#")&&(b="#"+a.jgrid.jqID(b));var
d,f,g=a(".navtable",b)[0];this.p.storeNavOptions&&this.p.navButtons.push([b,c]),g?(d="<td class='ui-pg-menu "+e.disabled+"' style='width:4px;'><span class='"+c.sepclass+"'></span>"+c.sepcontent+"</td>","first"===c.position?0===g.rows[0].cells.length?a("tr",g).append(d):a("tr td:eq(0)",g).before(d):a("tr",g).append(d)):(g=a(".dropdownmenu",b)[0],d="<li class='ui-menu-item "+e.disabled+"' style='width:100%' role='presentation'><hr class='ui-separator-li'></li>",g&&(f=a(g).val())&&("first"===c.position?a("#"+f).prepend(d):a("#"+f).append(d)))}})},_buildNavMenu:function(b,c,d,e,f,g,h,i){return this.each(function(){var
j=this,k=a.jgrid.getRegional(j,"nav"),l=j.p.styleUI,m=(a.jgrid.styleUI[l].navigator,a.jgrid.styleUI[l].filter),n=a.jgrid.styleUI[l].common,o="form_menu_"+a.jgrid.randId(),p=d.navButtonText?d.navButtonText:k.selectcaption||"Actions",q="<menu class='dropdownmenu "+n.button+"' value='"+o+"'>"+p+"</menu>";a(b+"_"+d.position,b).append(q);var
...
p="<span></span>";if(this.p.groupButton&&(p=a("<input type='menu' value='+ {}' title='"+f.p.subgroup+"' class='add-group "+j.button+"'/>"),p.on("click",function(){return void
...
q,r=a("<input type='menu' value='+' title='"+f.p.addrule+"' class='add-rule ui-add "+j.button+"'/>");r.on("click",function(){for(void
...
s=a("<input type='menu' value='-' title='"+f.p.delgroup+"' class='delete-group "+j.button+"'/>");l.append(s),s.on("click",function(){for(d=0;d<c.groups.length;d++)if(c.groups[d]===b){c.groups.splice(d,1);break}return f.reDraw(),f.onchange(),!1})}if(void
...
D=a("<input type='menu' value='-' title='"+n.p.delrule+"' class='delete-rule ui-del "+j.button+"'/>");C.append(D),D.on("click",function(){for(d=0;d<c.rules.length;d++)if(c.rules[d]===b){c.rules.splice(d,1);break}return n.reDraw(),n.onchange(),!1})}return p},this.getStringForGroup=function(a){var
b,c="(";if(void
...
p,q,r=a.extend([],d.p.colModel),s="<a id='"+f+"_search' class='fm-menu "+l.button+" fm-menu-icon-right ui-search'><span class='"+l.icon_base+" "+k.icon_search+"'></span>"+b.Find+"</a>",t="<a id='"+f+"_reset' class='fm-menu "+l.button+" fm-menu-icon-left ui-reset'><span class='"+l.icon_base+" "+k.icon_reset+"'></span>"+b.Reset+"</a>",u="",v="",w=!1,x=-1,y=!1,z=[];if(b.showQuery&&(u="<a id='"+f+"_query' class='fm-menu "+l.button+" fm-menu-icon-left'><span class='"+l.icon_base+" "+k.icon_query+"'></span>Query</a>"),b.columns.length?(r=b.columns,x=0,p=r[0].index||r[0].name):a.each(r,function(a,b){if(b.label||(b.label=d.p.colNames[a]),!w){var
c=void
...
d=a(c.target);return!b.searchOnEnter||13!==c.which||d.hasClass("add-group")||d.hasClass("add-rule")||d.hasClass("delete-group")||d.hasClass("delete-rule")||d.hasClass("fm-menu")&&d.is("[id$=_query]")?b.closeOnEscape&&27===c.which?(a("#"+a.jgrid.jqID(i.modalhead)).find(".ui-jqdialog-titlebar-close").click(),!1):void
...
0===h&&(h=!0),h&&a.isFunction(b.onReset)&&(h=b.onReset.call(d)),!1!==h&&a(d).trigger("reloadGrid",[{page:1}]),b.closeAfterReset&&a.jgrid.hideModal("#"+a.jgrid.jqID(i.themodal),{gb:"#gbox_"+a.jgrid.jqID(d.p.id),jqm:b.jqModal,onClose:b.onClose}),!1}),c(a("#"+f)),a(".fm-menu:not(."+l.disabled+")",m).hover(function(){a(this).addClass(l.hover)},function(){a(this).removeClass(l.hover)})}}})},filterInput:function(b,c){return c=a.extend(!0,{defaultSearch:"cn",groupOp:"OR",searchAll:!1,beforeSearch:null,afterSearch:null},c||{}),this.each(function(){var
d=this;if(d.grid){var
